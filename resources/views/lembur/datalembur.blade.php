                        ...
                        <table id="mytable" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ url('storage/foto_jam_masuk_lembur/' . $dl->foto_jam_masuk) }}" style="width: 60px">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        @if($dl->jam_keluar == null)
                                            <span class="badge badge-warning">Belum Pulang Lembur</span>
                                        @else
                                            <img src="{{ url('storage/foto_jam_keluar_lembur' . $dl->foto_jam_keluar) }}" style="width: 60px">
                                        @endif
                                    </td>
                                    <td>
                                        @if($dl->jam_keluar == null)
                                    ...
                                    <td>{{ $dl->notes }}</td>
                                    <td>{{ $dl->info_lembur }}</td> <!-- Menampilkan keterangan lembur -->
