            ...
            <div class="container welcome-inner">
                <div class="text-align-center mb-70">
                    <div class="main-logo center mb-50">
                        <div class="logo-icon">
                            <img src="{{ url('/gc/img/logo2.jp') }}" width="80" height="92">
                        </div>
                        <h2 class="logo-name">Portal DPL</h2>
                        <p class="logo-text">Portal DPL Application</p>
                    </div>
                    <h2 class="ma-0">Morning begins with Daksa Pangupakara Laras</h2>
                </div>
